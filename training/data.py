...
class ImageNetTransform:
    def __init__(self, resolution, center_crop=True, random_flip=False, random_resize_and_crop=False):
        if random_resize_and_crop:
            self.train_transform = transforms.Compose(
                [
                    transforms.RandomResizedCrop(resolution, scale=(0.75, 1.0), ratio=(0.9, 1.1)),
...
class ClassificationDataset:
    def __init__(
        ...
        random_resize_and_crop: bool = False,
        ...
        **kwargs,
        ...
        transform = ImageNetTransform(resolution, center_crop, random_flip, random_resize_and_crop)

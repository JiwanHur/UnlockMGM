...
if __name__ == "__main__":
    ...
    flax_model_path = f'./scripts/tokenizer_imagenet{resolution}_checkpoint'
    pytorch_dump_folder_path = f'./scripts/tokenizer_imagenet{resolution}_torch'
    convert(flax_model_path, pytorch_dump_folder_path)
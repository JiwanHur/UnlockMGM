...
from muse import EMAModel
from muse import MaskGitCorrTransformerOrg
...
def offline_ema(args):
    ...
    print(Path(checkpoint_dir_path) / dirs[0] / "unwrapped_model")
    print(dirs[0])
    transformer_config = MaskGitCorrTransformerOrg.load_config(dirs[0] / "unwrapped_model")
    # if transformer_config["_class_name"] == "MaskGitTransformer":
    #     model_cls = MaskGitCorrTransformerOrg
